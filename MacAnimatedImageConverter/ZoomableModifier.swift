        ...
        content
            ...
            .modify { view in
                if #available(iOS 17.0, macOS 14.0, *) {
                    view.gesture(magnificationGesture, isEnabled: isEnabled)
                } else {
                    view.gesture(oldMagnificationGesture, isEnabled: isEnabled)
                }
            }
            .gesture(doubleTapGesture, isEnabled: isEnabled)
    }
